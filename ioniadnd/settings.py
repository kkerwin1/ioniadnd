...
if "adjutant" in cwd:
	...
	ALLOWED_HOSTS = ["ionia.servegame.com", "localhost", "127.0.0.1", "10.0.0.16"]
	DATABASES = {
		"default": {
	...
	STATIC_URL = 'static/'
	STATIC_ROOT = BASE_DIR / "ioniadnd/static/"
	...
	ALLOWED_HOSTS = ["10.0.0.16","localhost","127.0.0.1"]
...
WSGI_APPLICATION = 'ioniadnd.wsgi.application'
